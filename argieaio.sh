...
wget -qO /etc/banner --header="Authorization: token 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" "https://raw.githubusercontent.com/nontikweed/blaire69/master/banner" 2>/dev/null
...
cd /etc || exit
wget -q -O /usr/sbin/sshws --header="Authorization: token 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" "https://raw.githubusercontent.com/nontikweed/aio/main/socks.py" 2>/dev/null

wget -q -O /usr/sbin/openvpnws --header="Authorization: token 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" "https://raw.githubusercontent.com/nontikweed/aio/main/openvpnws" 2>/dev/null
...
{
        wget -N --no-check-certificate --header="Authorization: Bearer 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" -q -O ~/install_server.sh https://raw.githubusercontent.com/nontikweed/blaire69/master/install_server.sh > /dev/null 2>&1
...
install_slowdns() {
    ...
    {  
        ...
        cd /etc/slowdns
        curl -s -H "Authorization: token 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" -o dns.sh "https://raw.githubusercontent.com/nontikweed/aio/main/dragonzdns" && chmod +x dns.sh && ./dns.sh  
        echo -e "[\e[32mInfo\e[0m] Downloading SlowDNS Files."
        wget --header="Authorization: Bearer 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" https://raw.githubusercontent.com/nontikweed/aio/main/slowdns > /dev/null 2>&1
...
installing_api(){
    ...
    echo -n -e "[\e[32mInfo\e[0m]" && echo -e " Installing API." | lolcat
    {
        ...
        wget -O /etc/slowdns/api/blaire.sh --header="Authorization: token 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" "https://raw.githubusercontent.com/nontikweed/tite/main/auth" > /dev/null 2>&1
